...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("** تمت إعادة تشغيل ✅**")
...
⧉ | لتشغيل صوتية في المكالمة أرسل ⇦ [ `{HNDLR}ت  + اسم الاغنية` ]
⧉ | لتشغيل فيديو في المكالمة  ⇦ [ `{HNDLR}تف  + اسم الاغنية` ]
———————×———————

⧉ | لأيقاف الاغنية او الفيديو مؤقتآ  ⇦ [ `{HNDL} اس` ] 
⧉ | لأعاده تشغيل الاغنية ⇦  [ `{HNDLR}ايس` ]
⧉ | لأيقاف الاغنية  ⇦ [ `{HNDLR}ا` ] 
———————×———————
...
⧉ | لأعاده تشغيل التنصيب أرسل ⇦  [ `{HNDLR}ريس` ]
———————×———————
🛠 | @VjljV
⭐ | @JJO0O"""
    await m.reply(HELP)
